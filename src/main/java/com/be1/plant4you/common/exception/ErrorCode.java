...
public enum ErrorCode {
    ...
    /**
     * NOT_FOUND : 리소스 없음
     * FORBIDDEN : 인증되었지만 권한 없음
     * NOT_ACCEPTABLE : 요청이 허용되지 않음
     */
    ...
    ALREADY_POST_LIKES(NOT_ACCEPTABLE, "이미 해당 게시글을 좋아요 하였습니다."),
    ALREADY_POST_SCRAP(NOT_ACCEPTABLE, "이미 해당 게시글을 스크랩 하였습니다."),
    INVALID_POST_LIKES(NOT_ACCEPTABLE, "좋아요 하지 않은 게시글이므로 좋아요 취소가 불가합니다."),
    INVALID_POST_SCRAP(NOT_ACCEPTABLE, "스크랩 하지 않은 게시글이므로 스크랩 취소가 불가합니다.");
